"""Tests for the reki ``test`` source provided by this package.
...
the ``reki.sources`` entry point group.
"""
...
import reki
import cedarkit_test_data.downloader
from cedarkit_test_data.reki_source import DEFAULT_DATA_DIR, TestSource
...
class TestEntryPoint:
    ...
    def test_end_to_end(self, fake_download, tmp_path):
        ...
        assert isinstance(data, GribReader)
